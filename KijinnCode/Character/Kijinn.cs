using Godot;
using Kijinn.KijinnCode.Cards.Basic;
...
[RegisterCharacter]
public class Kijinn : ModCharacterTemplate<KijinnCardPool, KijinnRelicPool, KijinnPotionPool>
{
    // 角色名称颜色
    ...
    public override CharacterAssetProfile AssetProfile => CharacterAssetProfiles.Merge(
        ...
        new(
            Scenes: new(
                // 人物模型tscn路径。
                VisualsPath: "res://Kijinn/scenes/KijinnChar.tscn"
                // 能量表盘tscn路径。
                // EnergyCounterPath: "res://Kijinn/scenes/Kijinn_energy_counter.tscn",
                // 商店人物场景。
                // MerchantAnimPath: "res://Kijinn/scenes/Kijinn_character_merchant.tscn"
                // 篝火休息场景。
                // RestSiteAnimPath: "res://Kijinn/scenes/Kijinn_character_rest_site.tscn"
            ),
            Ui: new(
                // 人物头像路径。
                ...
                // 人物选择背景。
                // CharacterSelectBgPath: "res://Kijinn/scenes/Kijinn_bg.tscn",
                // 人物选择图标。
                // CharacterSelectIconPath: "res://Kijinn/images/char_select_Kijinn.png",
                // 人物选择图标-锁定状态。
                // CharacterSelectLockedIconPath: "res://Kijinn/images/char_select_Kijinn_locked.png"
                // 人物选择过渡动画。
